...
/* S_TAG_KIND       */ {{ "Kind / Diameter", "Nature / Diametre", "Art / Durchmesser", "Tipo / Diametro", "Genere / Diametro", "Rodzaj / Srednica", "Genero / Diametro", "Genero / Diametro" }},
...
/* S_TAG_DRY        */ {{ "Dry temp. / Time", "Sechage temp. / Duree", "Trocknung Temp. / Zeit", "Secado temp. / Tiempo", "Essiccazione temp. / Tempo", "Suszenie temp. / Czas", "Secagem temp. / Tempo", "Secagem temp. / Tempo" }},
/* S_TAG_QTY        */ {{ "Quantity", "Quantite", "Menge", "Cantidad", "Quantita", "Ilosc", "Quantidade", "Quantidade" }},
...
/* S_SIG_NONE       */ {{ "not signed", "non signee", "nicht signiert", "sin firmar", "non firmata", "niepodpisany", "sem assinatura", "sem assinatura" }},
/* S_SIG_NOKEY      */ {{ "no public key", "pas de cle publique", "kein Schlussel", "sin clave publica", "nessuna chiave", "brak klucza", "sem chave publica", "sem chave publica" }},
...
/* S_LINK_FETCH     */ {{ "Reading your account", "Recuperation des donnees", "Konto wird gelesen", "Leyendo tu cuenta", "Lettura dell account", "Odczyt konta", "Lendo sua conta", "A ler a sua conta" }},
