...
/* S_LINK_FAIL      */ {{ "Connection failed", "Echec de connexion", "Verbindung fehlgeschlagen", "Fallo de conexion", "Connessione fallita", "Blad polaczenia", "Falha na conexao", "Falha na ligacao" }},
/* S_LF_SCAN        */ {{ "Scan for help", "Aide : scannez ce code", "Fur Hilfe scannen", "Escanea para ayuda", "Scansiona per aiuto", "Zeskanuj po pomoc", "Escaneie para ajuda", "Digitalize para ajuda" }},
/* S_LF_POWER       */ {{ "Printer switched on?", "Imprimante allumee ?", "Drucker eingeschaltet?", "Impresora encendida?", "Stampante accesa?", "Drukarka wlaczona?", "Impressora ligada?", "Impressora ligada?" }},
/* S_LF_NETWORK     */ {{ "Same network as this box?", "Sur le meme reseau que le boitier ?", "Im selben Netzwerk?", "En la misma red que la caja?", "Sulla stessa rete?", "W tej samej sieci?", "Na mesma rede da caixa?", "Na mesma rede da caixa?" }},
/* S_LF_SETTINGS    */ {{ "Check its settings in Tiger Studio Manager", "Verifiez ses parametres dans Tiger Studio Manager", "Einstellungen in Tiger Studio Manager prufen", "Revisa sus ajustes en Tiger Studio Manager", "Controlla le impostazioni in Tiger Studio Manager", "Sprawdz ustawienia w Tiger Studio Manager", "Verifique as definicoes no Tiger Studio Manager", "Verifique as definicoes no Tiger Studio Manager" }},
/* S_LF_BUSY        */ {{ "Too many connections - common on Bambu A1, A1 Mini, A2L, P1 and P1S", "Trop de connexions - frequent sur les Bambu A1, A1 Mini, A2L, P1 et P1S", "Zu viele Verbindungen - haufig bei Bambu A1, A1 Mini, A2L, P1 und P1S", "Demasiadas conexiones - habitual en Bambu A1, A1 Mini, A2L, P1 y P1S", "Troppe connessioni - frequente su Bambu A1, A1 Mini, A2L, P1 e P1S", "Zbyt wiele polaczen - czeste w Bambu A1, A1 Mini, A2L, P1 i P1S", "Muitas conexoes - comum em Bambu A1, A1 Mini, A2L, P1 e P1S", "Demasiadas ligacoes - comum em Bambu A1, A1 Mini, A2L, P1 e P1S" }},
