...
/* S_CLOUD_ONLY     */ {{ "Cloud printer - read only", "Imprimante cloud - lecture seule", "Cloud-Drucker - nur lesen", "Impresora cloud - solo lectura", "Stampante cloud - sola lettura", "Drukarka w chmurze - tylko odczyt", "Impressora na nuvem - somente leitura", "Impressora na nuvem - apenas leitura" }},
/* S_CLOUD_HOW      */ {{ "Switch it to LAN mode to write a spool", "Passez-la en mode LAN pour ecrire une bobine", "Fur das Schreiben in den LAN-Modus wechseln", "Cambia a modo LAN para escribir una bobina", "Passa in modalita LAN per scrivere una bobina", "Przelacz na tryb LAN aby zapisac szpule", "Mude para o modo LAN para gravar uma bobina", "Mude para o modo LAN para gravar uma bobina" }},
