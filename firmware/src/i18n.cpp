...
/* S_RESTART_Q      */ {{ "Restart the box?", "Redémarrer le boîtier ?", "Box neu starten?", "Reiniciar la caja?", "Riavviare la scatola?", "Uruchomic ponownie?", "Reiniciar a caixa?", "Reiniciar a caixa?" }},
...
/* S_FACTORY_WARN   */ {{ "This erases the network, the account and the printers.", "Ceci efface le réseau, le compte et les imprimantes.", "Loscht Netzwerk, Konto und Drucker.", "Borra la red, la cuenta y las impresoras.", "Cancella rete, account e stampanti.", "Usuwa siec, konto i drukarki.", "Isso apaga a rede, a conta e as impressoras.", "Isto apaga a rede, a conta e as impressoras." }},
